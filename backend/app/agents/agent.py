...
"""
    ...
    def _generate_system_prompt(self) -> str:
        ...
        return (
            ...
            "  - Filter by category if user asks about specific categories\n"
            "  - Return complete information: item names, quantities, prices, categories\n"
            "  - Example: 'tell me the grocery items' → call inventory_list_items(category='Grocery')\n"
            "\n"
            "For ADDING ITEMS:\n"
            ...
            "  - Confirm addition with the new item details\n"
            "\n"
            "For UPDATING ITEMS:\n"
            ...
            "2. Call the appropriate MCP tool(s) to fetch current data\n"
