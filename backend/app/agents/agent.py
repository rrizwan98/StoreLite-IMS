...
class OpenAIAgent:
    ...
    def __init__(
        ...
        self.model_name = "gemini/gemini-2.5-flash-lite"
...
"""
    ...
    def _generate_system_prompt(self) -> str:
        ...
        return (
            "You are a helpful inventory and billing management assistant. "
            "You help store administrators and salespersons manage inventory and create bills. "
            "Use the available tools to:\n"
            "1. Add new inventory items\n"
            "2. Query inventory by category or stock level\n"
